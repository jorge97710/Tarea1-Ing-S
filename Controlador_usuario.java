	...
	public void mostrarMenu() {
		while (resp != 0) {
			if (tipo >= 1) {
				...
				if (tipo == 3 || autorizacionCaja == true
						|| autorizacionInventario == true) {
					System.out.println("7. Dar acceso a encargado de caja");
					System.out
							.println("8. Dar acceso a encargado de inventario");
					System.out.println("9. Estadisticas de ventas");
				} else {
					System.out
							.println("Debe de ingresar un numero entre 0 y 9");
				}
				...
				if (resp == 5) {
					...
					while (nresp != 3) {
						if (nresp == 0) {
							...
							System.out
									.println("Ingrese el valor unitario del juguete");
							val_unit = sn.nextInt();
							System.out.println("Ingrese la marca del juguete ");
							marca = sn.nextLine();
							System.out.println("");
							System.out
									.println("Ingrese la edad minima para utilizar el juguete");
							min = sn.nextInt();
							System.out
									.println("Ingrese el tipo de juguete (0-electrico, 1-mecanico)");
							tipoj = sn.nextInt();
							if (tipoj == 0) {
					...
					if (resp == 6) {
						...
						while (nresp != 3) {
							if (nresp == 0) {
								...
								proveedores.add(new Proveedores(nombre,
