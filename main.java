...
public class main {
	...
	public static void main(String[] args) {
		...
		while (!salir) {
			...
			System.out.println("1. Empleado de caja"); // visualizar juguetes,
			// categorias y precios
			System.out.println("2. Encargado de inventario"); // ademas, editar
			// cantidades en
			// existencia y
			// precios,
			// agregar
			// nuevos
			// productos
			System.out.println("3. Director"); // ademas, reportes y
			// estadisticas
